...
<body style="margin:0;padding:0;background:#ffffff;font-family:'Poppins',-apple-system,BlinkMacSystemFont,'Helvetica Neue',Arial,sans-serif;color:#1a2332;-webkit-font-smoothing:antialiased;">
      ...
      <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="540" style="max-width:540px;width:100%;">
        <tr>
          <td align="center" class="pad" style="padding:0 24px 56px;">
            <div class="mark" style="font-family:'Cormorant Garamond','Palatino Linotype',Georgia,serif;font-weight:500;font-size:56px;line-height:1.05;letter-spacing:-1.4px;color:#03617A;white-space:nowrap;">
              The Church of Peace
            </div>
          </td>
        </tr>
        ...
        <tr>
          <td align="center" class="pad" style="padding:0 24px 32px;">
            <p class="lede" style="margin:0;font-family:'Cormorant Garamond','Palatino Linotype',Georgia,serif;font-size:22px;font-weight:400;line-height:1.4;letter-spacing:-0.2px;color:#1a2332;">
              ...
              <tr>
                <td align="center" bgcolor="#03617A" style="border-radius:6px;">
                  <a href="{{ $url }}" class="btn"
                     style="display:inline-block;padding:18px 56px;font-family:'Poppins',-apple-system,'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#ffffff;text-decoration:none;border-radius:6px;mso-padding-alt:18px 56px;">
                    Sign in
                  </a>
                </td>
              </tr>
        ...
        <tr>
          <td align="center" class="pad" style="padding:8px 24px 56px;">
            <p style="margin:0;font-family:'Poppins',-apple-system,'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:1.6;color:#334455;">
              Expires in 30 minutes &middot; One-time use<br>
              <span style="color:#334455;opacity:0.75;">Didn't request this? Safely ignore.</span>
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td align="center" class="pad" style="padding:32px 24px 0;border-top:1px solid rgba(26,35,50,0.10);">
            <p style="margin:0;font-family:'Poppins',-apple-system,'Helvetica Neue',Arial,sans-serif;font-size:11px;font-weight:500;letter-spacing:2px;text-transform:uppercase;color:#334455;">
              Shalom Seventh-day Adventist Church
            </p>
            <p style="margin:6px 0 0;font-family:'Poppins',-apple-system,'Helvetica Neue',Arial,sans-serif;font-size:11px;line-height:1.6;color:#334455;">
              3323 White Plains Rd &middot; Bronx, NY<br>
              <a href="mailto:contact@thechurchofpeace.org" style="color:#334455;text-decoration:underline;">contact@thechurchofpeace.org</a>
            </p>
          </td>
        </tr>
      </table>
