...
<style>
  :root { --parchment:#fefcef; --ink:#1a2332; --ink-soft:#334455; --teal:#03617A; --teal-bright:#048aaa; --line:rgba(26,35,50,0.10); }
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .sermon-card { background: rgba(3,97,122,0.04); border-left: 3px solid var(--teal); padding: 16px 20px; text-align: left; margin: 0 auto 28px; max-width: 440px; border-radius: 0 6px 6px 0; }
