...
<style>
  ...
  *:focus-visible { outline: 2px solid var(--teal); outline-offset: 2px; border-radius: 3px; }
  ...
  .viewseg { display: inline-flex; background: var(--parchment); border: 1px solid var(--line); border-radius: 999px; padding: 3px; gap: 2px; }
  .viewseg button {
    font-family: 'Instrument Sans', sans-serif; font-size: 11px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase;
    border: 0; background: transparent; color: var(--ink-soft); border-radius: 999px;
  ...
  #hub-search { width: 100%; font: inherit; font-size: 14px; padding: 10px 14px 10px 38px; background: var(--parchment); color: var(--ink); border: 1px solid var(--line); border-radius: 999px; }
