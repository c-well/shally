...
<main>
  ...
  <form class="add-form" method="POST" action="{{ route('admin.slides.store') }}" enctype="multipart/form-data">
    ...
    <div class="field full">
      ...
      <!-- UPLOAD_HEIC_HARDENED: explicit MIME list discourages macOS Photos picker which would auto-convert to HEIC. -->
      <!-- NATIVE_SAFARI_HEIC_CONVERSION: explicitly omitting .heic from accept tells Safari to auto-convert HEIC->JPEG during upload. Listing .heic was DISABLING that conversion. -->
...
(function () {
  ...
  fileInput.addEventListener("change", async (e) => {
    ...
    if (label) label.textContent = "⏳ Converting HEIC… (please wait — DO NOT click Upload yet)";
    const submitBtn = document.getElementById("slide-upload-btn");
