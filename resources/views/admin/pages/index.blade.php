...
<style>
  ...
  *:focus-visible { outline: 2px solid var(--teal); outline-offset: 2px; border-radius: 3px; }
  ...
  h1 { font-family: 'Instrument Sans', sans-serif; font-size: clamp(28px, 4vw, 38px); font-weight: 500; letter-spacing: -0.015em; line-height: 1.05; margin-bottom: 4px; }
  ...
  .row .title { font-family: 'Instrument Sans', sans-serif; font-size: 22px; font-weight: 500; line-height: 1.2; }
